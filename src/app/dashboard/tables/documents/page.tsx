...
const initialLabelsList: Label[] = [
  {
    ...
    description: "Please print manual ann quick start guide",
    user: "Oscar Beltran",
  },
  {
    id: 2,
    ...
    description: "Please print quick start guide and guarantee instructions",
    user: "Silvestre",
  },
  {
    id: 3,
    ...
    model: "32GN550",
    description: "Please print installation guide and manual",
    user: "Oscar Beltran",
  },
];

function DocumentsLabels() {
  ...
  return (
    <div className="container mx-auto p-4 max-w-lg">
      <h1 className="text-center text-3xl font-bold mt-[30px]">Documents pending</h1>
...
export default DocumentsLabels;
